      ...
      comparison_group_list: [
        {
          ...
          ci_upper: 3.63,
          patient_population:
            "High - Consistent across meta-analysis of real-world data. 4",
        },
      ],
    },
  ],
      ...
      comparison_group_list: [
        {
          ...
          ci_upper: undefined,
          patient_population:
            "High - Based on foundational IASLC database analysis. 19",
        },
      ],
    },
    {
      ...
      comparison_group_list: [
        {
          ...
          ci_upper: undefined,
          patient_population:
            "Moderate to High - Supported by multiple meta-analyses. 30",
        },
      ],
    },
  ],
      ...
      comparison_group_list: [
        {
          ...
          ci_upper: 1.89,
          patient_population:
            "High - Based on large, multivariate-adjusted cohort study. 17",
        },
        {
      ...
      comparison_group_list: [
        {
          ...
          ci_upper: 1.91,
          patient_population:
            "High - Consistent across systematic review and meta-analysis. 37",
        },
      ],
    },
  ],
  [Biomarker.LUNG_PDL1_EXPRESSION]: [
    {
      ...
      reference_group: {
        type: "categorical",
        category: "Low (Untreated, Early Stage)",
      },
      comparison_group_list: [
        {
          ...
          ci_upper: 1.83,
          patient_population:
            "High - Consistent across multiple meta-analyses. 27",
        },
      ],
    },
  ],
  [Biomarker.METASTATIC_SITE]: [
    {
      ...
      reference_group: {
        type: "categorical",
        category: "Absence of Liver Metastases",
      },
      comparison_group_list: [
        {
          ...
          ci_upper: 1.5,
          patient_population:
            "High - Based on large-scale SEER database analysis. 6",
        },
      ],
    },
  ],
      ...
      comparison_group_list: [
        {
          ...
          ci_upper: undefined,
          patient_population:
            "High - Consistent across multiple meta-analyses. 9",
        },
      ],
    },
  ],
      ...
      comparison_group_list: [
        {
          ...
          ci_upper: 1.04,
          patient_population:
            "High - Prognostically neutral based on meta-analysis. 31",
        },
      ],
    },
  ],
  [Biomarker.LUNG_ALK_REARRANGEMENT]: [
    {
      ...
      reference_group: {
        type: "categorical",
        category: "ALK- (Untreated, Matched)",
      },
      comparison_group_list: [
        {
          ...
          ci_upper: 1.67,
          patient_population:
            "Moderate - Prognostically neutral in matched analysis. 33",
        },
      ],
    },
  ],
